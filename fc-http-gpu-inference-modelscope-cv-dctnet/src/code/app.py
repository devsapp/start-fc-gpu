...
img_cartoon = pipeline(Tasks.image_portrait_stylization,
                       model='./model/damo/cv_unet_person-image-cartoon_compound-models')
...
def ping():
    ...
    img_path = './test/img/image_ping.png'
...
def invoke():
    ...
    try:
        ...
        # inference
        result = img_cartoon(path_in)
        cv2.imwrite(path_out, result[OutputKeys.OUTPUT_IMG])
